...
const RegistroDeCuentaValidado1 = () => {
  ...
  return (
    <View style={styles.registroDeCuentaValidadoView}>
      ...
      <Text
        style={[styles.abrilrivera1246gmailcomText, styles.mt21, styles.ml54]}
      >
      ...
      <Text style={[styles.contraseaActualText, styles.mt19, styles.ml54]}>
        Contraseña actual
      </Text>
      <Image
      ...
      <Image
        style={[styles.cerraduraIcon2, styles.mt_15, styles.ml26]}
        resizeMode="cover"
        source={require("../assets/cerradura.png")}
      />
...
export default RegistroDeCuentaValidado1;
